...
urlpatterns = [
        ...
        path('update_reporting_je_form_hindi/<int:tagging_id>/',views.update_reporting_je_form_hindi,name='update_reporting_je_form_hindi'),
        path('update_reporting_ta_form_hindi/<int:tagging_id>/',views.update_reporting_ta_form_hindi,name='update_reporting_ta_form_hindi'),
